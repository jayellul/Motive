...
class FeedViewController: UIViewController, SliderDelegate, TabDelegate {
...
extension FeedViewController: UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, CalloutViewDelegate {
